...
use todoist\Mock\OpenApiDataMockerInterface;
use InvalidArgumentException;

/**
 * OpenApiDataMockerMiddleware Class Doc Comment
 *
 * @package todoist\Mock
 * @author  OpenAPI Generator team
 * @link    https://github.com/openapitools/openapi-generator
 */
final class OpenApiDataMockerMiddleware implements MiddlewareInterface
{
     ...
     *     if (
     *         $request->hasHeader('X-todoist-Mock')
     *         && $request->header('X-todoist-Mock')[0] === 'ping'
     *     ) {
     ...
     *     return $response->withHeader('X-todoist-Mock', 'pong');
     * };
     */
